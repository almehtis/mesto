  ...
  return (
    <div className={cn("card", props.className)}>
      <div className="card__title-block">
        ...
        {props.iconName === 'gloube' && <div className="card__icon-wrapper">
          <svg className="card__icon-wrapper__svg" width="100%" height="100%" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {props.iconName === 'snowflake' && <div className="card__icon-wrapper">
          <svg className="card__icon-wrapper__svg" width="100%" height="100%" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {props.iconName === 'circle-arrow-up' && <div className="card__icon-wrapper">
          <svg className="card__icon-wrapper__svg" width="100%" height="100%" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="110" cy="110" r="107" stroke="#D8E6F1" stroke-width="6"/>
